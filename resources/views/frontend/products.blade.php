            ...
            <div class="flex justify-center my-4">
                <form class="flex items-center w-full max-w-md">
                    <div class="relative flex w-full">            
                        <input class="form-control pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-gray-500 w-full" type="search" placeholder="Search products" aria-label="Search">
                    </div>
                </form>
            </div>
